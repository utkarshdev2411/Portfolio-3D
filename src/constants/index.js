...
export const experiences = [
  {
    ...
    job: "Edviron (Thrivedge Edutech Pvt. Ltd.)",
    date: "Sept 2025 - Current",
    contents: [
      "Engineering cutting-edge AI-driven fintech platform streamlining payment processes for educational institutions with automated fee collection.",
      "Architecting robust full-stack applications using Nest.js, React.js, Tailwind CSS, MongoDB, and AWS with enterprise-grade security.",
      "Leveraging APIs for real-time transaction insights, digital KYC, automated invoice and policy generation solutions.",
      "Building scalable, cloud-native reconciliation systems ensuring high performance for financial operations.",
    ],
  },
  {
    title: "Full-Stack Developer",
    job: "CoolBoots Media Private Limited",
    date: "June 2025 - Sept 2025",
    contents: [
      "Spearheaded development of next-gen interactive gaming platform with story generation powered by LLMs (OpenAI, Claude, Gemini, DALL·E).",
      "Built full-stack React.js/FastAPI/PostgreSQL/Tailwind CSS solutions on GCP with multi-session narratives and AI moderation.",
      "Engineered world-building systems and payment integration with structured milestones from MVP to production.",
      "Implemented dynamic story state management focusing on code quality and scalable infrastructure.",
    ],
  },
  {
    title: "Tech Lead Intern",
    job: "Career Crush Labs",
    date: "Jan 2025 - May 2025",
    contents: [
      "Architected secure, RESTful backend systems with clean database schemas following enterprise design patterns.",
      "Mentored developers on Git workflows, debugging, documentation, and modular design fostering collaborative excellence.",
      "Collaborated with founders to translate business requirements into technical specifications and development roadmaps.",
      "Led sprint planning and code reviews ensuring consistency, scalability, and maintainability across codebase.",
    ],
  },
  {
    ...
    contents: [
      "Developed Generative AI-powered system enhancing resume ATS scores, reducing modification time by 30 minutes per resume.",
      "Engineered production-grade APIs for user management and resume generation leveraging Azure OpenAI capabilities.",
      "Integrated cutting-edge AI models with robust backend architecture, significantly enhancing system functionality.",
      "Contributed scalable, maintainable code following SOLID principles and industry best practices.",
    ],
  },
];
export const techStack = [
  {
    name: "React.js",
    username: "@frontend",
    body: "Building interactive user interfaces with component-based architecture and hooks",
    img: "/assets/logos/react.svg",
  },
  {
    name: "Tailwind CSS",
    username: "@frontend",
    body: "Utility-first CSS framework for rapid UI development and responsive design",
    img: "/assets/logos/tailwindcss.svg",
  },
  {
    name: "HTML5",
    username: "@frontend",
    body: "Semantic markup and modern web standards for accessible, structured content",
    img: "/assets/logos/html5.svg",
  },
  {
    name: "CSS3",
    username: "@frontend",
    body: "Advanced styling with animations, flexbox, grid, and responsive design patterns",
    img: "/assets/logos/css3.svg",
  },
  {
    name: "Node.js",
    username: "@backend",
    body: "Scalable server-side JavaScript runtime for building high-performance APIs",
    img: "/assets/logos/nodejs.png",
  },
  {
    name: "Python",
    username: "@languages",
    body: "Versatile language for backend development, AI/ML, and data processing",
    img: "/assets/logos/python.png",
  },
  {
    name: "JavaScript",
    username: "@languages",
    body: "ES6+ features for modern full-stack web development and async programming",
    img: "/assets/logos/javascript.svg",
  },
  {
    name: "SQL Server",
    username: "@database",
    body: "Enterprise-grade relational database with advanced querying and data management",
    img: "/assets/logos/microsoftsqlserver.svg",
  },
  {
    name: "SQLite",
    username: "@database",
    body: "Lightweight embedded database for local data storage and rapid prototyping",
    img: "/assets/logos/sqlite.svg",
  },
  {
    name: "Azure",
    username: "@cloud",
    body: "Microsoft cloud platform for enterprise-grade solutions and AI services",
    img: "/assets/logos/azure.svg",
  },
  {
    name: "Git",
    username: "@devops",
    body: "Version control system for collaborative development and code management",
    img: "/assets/logos/git.svg",
  },
  {
    name: "GitHub",
    username: "@devops",
    body: "Code hosting platform with CI/CD pipelines and collaborative workflows",
    img: "/assets/logos/github.svg",
  },
  {
    name: "VS Code",
    username: "@devops",
    body: "Modern code editor with debugging, IntelliSense, and extensive extensions",
    img: "/assets/logos/visualstudiocode.svg",
  },
  {
    name: "Three.js",
    username: "@frontend",
    body: "3D graphics library for creating immersive web experiences and visualizations",
    img: "/assets/logos/threejs.svg",
  },
  {
    name: "Vite.js",
    username: "@frontend",
    body: "Lightning-fast build tool with hot module replacement for modern web apps",
    img: "/assets/logos/vitejs.svg",
  },
  {
    name: "ChatGPT",
    username: "@ai",
    body: "GPT models for natural language processing and generative AI applications",
